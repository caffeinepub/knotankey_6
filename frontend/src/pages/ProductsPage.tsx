    ...
    <div className="min-h-screen bg-background pt-20">
      ...
      <div className="bg-secondary/30 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-muted-foreground font-sans max-w-xl mx-auto">
            Explore our handcrafted crochet pieces — each one made with love and care.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-6">
          ...
          {hasActiveFilters && (
            <Button variant="ghost" onClick={clearFilters} className="gap-2 font-sans">
              <X className="w-4 h-4" />
              Clear
            </Button>
          )}
        ...
        {!isLoading && !isError && filteredProducts.length === 0 && (
          <div className="text-center py-20 text-muted-foreground">
            ...
            {hasActiveFilters && (
              <Button variant="outline" onClick={clearFilters} className="font-sans">
                Clear Filters
              </Button>
            )}
          </div>
