...
import type { CustomOrderRequest as _CustomOrderRequest, ExternalBlob as _ExternalBlob, Product as _Product, ReturnRequest as _ReturnRequest, Time as _Time, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
...
async function from_candid_CustomOrderRequest_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CustomOrderRequest): Promise<CustomOrderRequest> {
...
async function from_candid_ReturnRequest_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ReturnRequest): Promise<ReturnRequest> {
...
async function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_CustomOrderRequest>): Promise<Array<CustomOrderRequest>> {
    return await Promise.all(value.map(async (x)=>await from_candid_CustomOrderRequest_n18(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ReturnRequest>): Promise<Array<ReturnRequest>> {
    return await Promise.all(value.map(async (x)=>await from_candid_ReturnRequest_n21(_uploadFile, _downloadFile, x)));
}
