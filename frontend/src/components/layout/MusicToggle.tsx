...
const MUSIC_SRC = 'https://cdn.pixabay.com/download/audio/2022/03/15/audio_115b9b8c69.mp3';
...
export default function MusicToggle() {
  ...
  const fadeIn = (audio: HTMLAudioElement) => {
    ...
    fadeIntervalRef.current = setInterval(() => {
      ...
      const next = Math.min(audioRef.current.volume + stepSize, TARGET_VOLUME);
