  ...
  return (
    <div className="pt-20 min-h-screen">
      <div className="bg-cream-200 py-16 px-4 text-center border-b border-cream-300">
        <p className="font-sans text-xs tracking-[0.3em] uppercase text-warm-tan mb-3">
          Your Selection
        </p>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {items.length === 0 ? (
          <div className="text-center py-24">
            ...
            <h2 className="font-serif text-3xl text-warm-tan mb-4">
              Your cart is empty
            </h2>
            <p className="font-sans text-warm-tan/70 mb-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-1">
              <div className="bg-card rounded-3xl shadow-soft border border-cream-300 p-6 sticky top-24">
                <h3 className="font-serif text-xl text-warm-brown mb-5">
                  Order Summary
                </h3>
