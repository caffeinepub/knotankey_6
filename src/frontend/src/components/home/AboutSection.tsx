  ...
  return (
    <section ref={sectionRef} className="relative py-24 overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('/assets/generated/crochet-about-bg.dim_1920x1080.jpg')`,
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(rgba(0,0,0,0.35), rgba(0,0,0,0.45), rgba(0,0,0,0.55))",
        }}
      />
      ...
      >
        ...
        <div
          ...
          style={{ backgroundColor: "#F8F5F0", opacity: 0.6 }}
        />
        ...
        >
          knotankey creates soft luxury crocheted pieces designed to bring
          warmth, comfort, and elegance into everyday life.
        </p>
        ...
        >
          Every stitch is placed with care, every piece made to last — because
