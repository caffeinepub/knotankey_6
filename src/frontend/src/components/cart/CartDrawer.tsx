        ...
        <div className="flex-1 overflow-y-auto px-6">
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center py-16">
              ...
              <p className="font-serif text-xl text-warm-tan mb-2">
                Your cart is empty
              </p>
              <p className="font-sans text-sm text-warm-tan/70">
        ...
        {items.length > 0 && (
          <div className="px-6 py-5 border-t border-cream-300 bg-cream-100">
            <div className="flex justify-between items-center mb-5">
              <span className="font-sans text-sm text-warm-tan uppercase tracking-wider">
                Total
              </span>
